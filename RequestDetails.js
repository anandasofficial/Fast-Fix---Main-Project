   ...
   {requestId}
      <div className="requestPage__conatiner">
        <div className="requestPage__top">
          ...
          width: '200px',height: '100px',marginLeft: '540px'}}>
            <p>Hours Worked</p>
          <select 
              
              style={{backgroundColor: 'white',borderRadius: '5px',border: '1px solid black'}}
              value={hours}
              ...
              <Button onClick={finishTask} style={{marginLeft: '10px',color: 'green',border: '1px solid green',
              height: '20px'}}>Finish Work</Button>
              </div>:null}
          ...
          <div className="description__containersRight">
            ...
            <p>
              ...
              <strong>
                ...
                <Button onClick={() => {setShowSecond(true);No();}}>No</Button>
              </strong>
            </p>
            {show ? (
              <Button
